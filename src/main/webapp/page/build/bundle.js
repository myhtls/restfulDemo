...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = new _Vue2.default({
	    ...
	    data: {
	        message: 'Hello Vue!',
	        items: [{ firstName: 'du', lastName: 'jiuLing', userName: 'duJiuLing1' }, { firstName: 'du', lastName: 'jiuLing', userName: 'duJiuLing2' }, { firstName: 'du', lastName: 'jiuLing', userName: 'duJiuLing3' }, { firstName: 'du', lastName: 'jiuLing', userName: 'duJiuLing4' }, { firstName: 'du', lastName: 'jiuLing', userName: 'duJiuLing5' }]
	    }
	});
	$("#app").show();
